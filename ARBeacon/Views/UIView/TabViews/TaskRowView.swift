                ...
                if currentTask.subTasks.count == 0 {
                    ...
                    List(currentTask.subTasks) { subTask in
                        HStack {
                            ...
                            Image(systemName: subTask.subTaskIsCompleted ?? false ? Constants.completedTaskImage : Constants.incompleteTaskImage)
                                .foregroundColor(subTask.subTaskIsCompleted ?? false ? Constants.customGreen : Constants.customOrange)
                            Spacer()
                        }
                        .font(.system(size: 24))
                        .padding(.vertical, 8)
